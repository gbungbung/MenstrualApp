...
class Root(ScreenManager):
    ...
    def __init__(self, **kwargs):
        ...
        with open("./uix/screens.json") as f:
    ...
    def set_current(self, screen_name, side="left", _from_goback=False):
        ...
        Create your screen files like below:
            1. Create screen_file.py in uix/baseclass/
            2. Create screen_file.kv in uix/kv/
            3. Add the screen details in screens.json like below:
                {
                    ...,
                    "screen_name": {
                        "import": "from uix.baseclass.screen_py_file import ScreenObjectName",
                        "object": "ScreenObjectName()",
                        "kv": "uix/kv/screen_kv_file.kv"
                    }
                }
